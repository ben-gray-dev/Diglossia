(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@kamiazya/ngx-speech-recognition', ['exports', 'rxjs', 'rxjs/operators', '@angular/core', '@angular/common'], factory) :
    (factory((global.kamiazya = global.kamiazya || {}, global.kamiazya['ngx-speech-recognition'] = {}),global.rxjs,global.rxjs.operators,global.ng.core,global.ng.common));
    ...
    ***************************************************************************** */
    ...
    var SpeechRecognitionService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        SpeechRecognitionService.ctorParameters = function () {
            return [
                { type: core.ApplicationRef },
                { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: [SpeechRecognitionGrammars,] }] },
                { type: String, decorators: [{ type: core.Optional }, { type: core.Inject, args: [SpeechRecognitionLang,] }] },
                ...
                { type: Number, decorators: [{ type: core.Optional }, { type: core.Inject, args: [SpeechRecognitionMaxAlternatives,] }] },
                { type: String, decorators: [{ type: core.Optional }, { type: core.Inject, args: [SpeechRecognitionServiceUri,] }] },
                { type: Function, decorators: [{ type: core.Optional }, { type: core.Inject, args: [SpeechRecognitionAudiostartHandler,] }] },
                { type: Function, decorators: [{ type: core.Optional }, { type: core.Inject, args: [SpeechRecognitionSoundstartHandler,] }] },
                { type: Function, decorators: [{ type: core.Optional }, { type: core.Inject, args: [SpeechRecognitionSpeechstartHandler,] }] },
                { type: Function, decorators: [{ type: core.Optional }, { type: core.Inject, args: [SpeechRecognitionSpeechendHandler,] }] },
                { type: Function, decorators: [{ type: core.Optional }, { type: core.Inject, args: [SpeechRecognitionSoundendHandler,] }] },
                { type: Function, decorators: [{ type: core.Optional }, { type: core.Inject, args: [SpeechRecognitionAudioendHandler,] }] },
                { type: Function, decorators: [{ type: core.Optional }, { type: core.Inject, args: [SpeechRecognitionResultHandler,] }] },
                { type: Function, decorators: [{ type: core.Optional }, { type: core.Inject, args: [SpeechRecognitionNomatchHandler,] }] },
                { type: Function, decorators: [{ type: core.Optional }, { type: core.Inject, args: [SpeechRecognitionErrorHandler,] }] },
                { type: Function, decorators: [{ type: core.Optional }, { type: core.Inject, args: [SpeechRecognitionStartHandler,] }] },
                { type: Function, decorators: [{ type: core.Optional }, { type: core.Inject, args: [SpeechRecognitionEndHandler,] }] }
            ];
        };
    ...
    var SpeechRecognitionModule = /** @class */ (function () {
        function SpeechRecognitionModule(platformId) {
            if (common.isPlatformBrowser(platformId) === false) {
        ...
        /** @nocollapse */
        SpeechRecognitionModule.ctorParameters = function () {
            return [
    ...
    exports.SpeechRecognitionGrammars = SpeechRecognitionGrammars;
    exports.SpeechRecognitionLang = SpeechRecognitionLang;
    exports.SpeechRecognitionContinuous = SpeechRecognitionContinuous;
    exports.SpeechRecognitionInterimResults = SpeechRecognitionInterimResults;
    exports.SpeechRecognitionMaxAlternatives = SpeechRecognitionMaxAlternatives;
    exports.SpeechRecognitionServiceUri = SpeechRecognitionServiceUri;
    exports.SpeechRecognitionAudiostartHandler = SpeechRecognitionAudiostartHandler;
    exports.SpeechRecognitionSoundstartHandler = SpeechRecognitionSoundstartHandler;
    exports.SpeechRecognitionSpeechstartHandler = SpeechRecognitionSpeechstartHandler;
    exports.SpeechRecognitionSpeechendHandler = SpeechRecognitionSpeechendHandler;
    exports.SpeechRecognitionSoundendHandler = SpeechRecognitionSoundendHandler;
    exports.SpeechRecognitionAudioendHandler = SpeechRecognitionAudioendHandler;
    exports.SpeechRecognitionResultHandler = SpeechRecognitionResultHandler;
    exports.SpeechRecognitionNomatchHandler = SpeechRecognitionNomatchHandler;
    exports.SpeechRecognitionErrorHandler = SpeechRecognitionErrorHandler;
    exports.SpeechRecognitionStartHandler = SpeechRecognitionStartHandler;
    exports.SpeechRecognitionEndHandler = SpeechRecognitionEndHandler;
    exports.resultList = resultList;
    exports.RxSpeechRecognitionService = RxSpeechRecognitionService;
    exports.SpeechRecognitionService = SpeechRecognitionService;
    exports.SPEECH_RECOGNITION_DEFAULT = SPEECH_RECOGNITION_DEFAULT;
    exports.SpeechRecognitionModule = SpeechRecognitionModule;
    exports.ɵa = SpeechRecognitionCommon;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=kamiazya-ngx-speech-recognition.umd.js.map